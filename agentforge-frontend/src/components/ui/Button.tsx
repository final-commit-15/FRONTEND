...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'default' | 'outline' | 'ghost' | 'danger';
  size?: 'sm' | 'md' | 'lg' | 'icon';
  loading?: boolean;
...
const variantClasses = {
  ...
  default: 'bg-brand-primary text-white hover:bg-brand-primary-hover focus-visible:ring-brand-primary shadow-glow-blue hover:shadow-glow-blue-hover',
  outline: 'bg-transparent text-text-heading border border-canvas-border hover:bg-canvas-glass hover:text-text-heading focus-visible:ring-text-muted',
